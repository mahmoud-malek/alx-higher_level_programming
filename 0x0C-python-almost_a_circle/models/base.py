...
class Base:
    """This is the base model for all other classes in the project.

    Private Class Attributes:
        __nb_object (int): The count of Base instances.
    """
    ...
    def load_from_file(cls):
        """Loads a list of class instances from a JSON file.
    ...
    def load_from_file_csv(cls):
        """Loads a list of class instances from a CSV file.
